...
<head>
    ...
    <title>LadyLike | Final Year Project</title>
                ...
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="https://www.facebook.com/LadyLike/" target="_blank"><i
                                        class="fa fa-facebook"></i></a></li>
                            <li><a href="https://www.instagram.com/ladylike/" target="_blank"><i
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a
                                            href="{{URL::to('/product-by-category'.$category->category_id)}}">{{$category->category_name}}</a>
                                    </h4>
                                </div>
                            </div>
                            <?php } ?>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{{URL::to('/product_by_manufacture'.$manufacture->manufacture_id)}}"> <span
                                            class="pull-right"></span>{{$manufacture->manufacture_name}}</a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div><!--/brands_products-->
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        <h2><span>Lady</span>Like</h2>
                        <p>This online boutique is a small shop that typically sells fashionable clothing through the
                            Internet.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="address">
                        ...
                        <p>Main kapra market sameejabad, Multan</p>
                    </div>
                </div>
            </div>
        </div>
...
{{--        <div class="container">--}}
{{--            <div class="row">--}}
{{--                <p class="pull-left">Copyright © 2013--}}
{{--                    Ladylike Inc. All rights reserved.</p>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
