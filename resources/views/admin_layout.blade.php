...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="/"><span>LadyLike</span></a>
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{URL::to('/all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Category</span></a>
                    </li>
                    ...
                    <li><a href="{{URL::to('/all-manufacture')}}"><i class="icon-eye-open"></i><span
                                class="hidden-tablet">All Manufacture</span></a></li>

                    <li><a href="{{URL::to('/add-manufacture')}}"><i class="icon-dashboard"></i><span
                                class="hidden-tablet">Add Manufacture</span></a></li>
                    ...
                    <li><a href="{{URL::to('/manage_order')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Order Details</span></a>
                    </li>
                    <li><a href="{{URL::to('/view_queries')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">View Messages</span></a>
                    </li>
                </ul>
            </div>
        </div>
...
<footer>
    ...
    <p>
        <span style="text-align:left;float:left">&copy; 2022 <a href="#" alt="Bootstrap Themes">FYP</a></span>
        <span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="#"
                                                                                       alt="Bootstrap Admin Templates">BSCS 2K18</a></span>
    </p>
...
<script type="text/javascript"
        src="{{asset('https://cdn.jsdelivr.net/npm/bootbox@5.4.0/bootbox.all.min.js')}}"></script>
